...
const DesignPhilosophy = () => {
  return (
    <div
      className="section-top px-10 flex justify-center xl:gap-50 gap-10 items-center flex-wrap"
      id="about"
    >
      <div className="max-w-96">
        <p className="text-cream pb-6 lg:pb-4 text-5xl lg:text-4xl text-center lg:text-start font-bold">
          About Our Design
          <br /> Philosophy
        </p>
        <p className="text-muted text-center lg:text-start lg:text-lg pb-4 text-base">
          With over a decade of experience in interior design, we believe that
          every space should be a perfect blend of aesthetics and functionality.
          Our approach focuses on understanding your lifestyle, preferences, and
          needs to create spaces that truly feel like home.
        </p>
