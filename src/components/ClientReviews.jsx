      ...
      <div className="flex justify-center mx-4 lg:gap-10 gap-5 mt-10 flex-wrap">
        <div className="card w-80">
          ...
          <p className="pb-6 text-muted">
            "Working with {BUSINESS_NAME} team was an absolute pleasure. From
            the initial consultation to the final reveal, their team was
            professional, creative, and attentive to our needs."
          </p>
        ...
        <div className="card w-80">
          ...
          <p className="pb-6 text-muted">
            "{BUSINESS_NAME} team provide us with the new designs and still try
            to fit them in our budget and the project ended on budget which
            alone speaks volume"
          </p>
        ...
        <div className="card w-80">
          ...
          <p className="pb-4 text-muted">
            "The attention to detail and the quality of {BUSINESS_NAME} team
